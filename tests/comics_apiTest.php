...
use datagutten\comics_tools\comics_api_client\comics_api;
...
class comics_apiTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->comics = new comics_api($config);
    }
    ...
    public function testInvalidKey()
    {
        ...
        $comics = new comics_api(['site_url'=>$this->comics->site_url, 'secret_key'=>'bad']);
    ...
    public function testFormat_releases()
    {
        ...
        $releases = comics_api::format_releases($releases);
    ...
    {
        list($start, $end) = comics_api::month('10', '2020');
